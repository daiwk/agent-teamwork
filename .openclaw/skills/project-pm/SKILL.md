---
name: project-pm
description: Run the repository in PM/orchestrator mode by default. Analyze, decompose, document, assign ownership, and delegate implementation instead of directly patching code.
---
...
5. delegate implementation to coding-agent or eng-executor instead of directly doing large code edits
...
- For large code edits, use coding-agent or eng-executor instead of directly editing code yourself.
...
6. if implementation is requested, call coding-agent or eng-executor with the task file as the source of truth
